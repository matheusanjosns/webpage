...
CREATE TABLE `itenspedido` (
  ...
  CONSTRAINT `fk_itensPedido_produto1` FOREIGN KEY (`produto_idProduto`) REFERENCES `produto` (`idProduto`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2021-06-14 17:17:57
